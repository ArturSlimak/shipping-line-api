...
public class CreateVoyageRequest {
    ...
    public CreateVoyageRequest(String voyageNumber, Long vesselId, Long departurePortId, Long arrivalPortId, LocalDateTime departureTime, LocalDateTime arrivalTime, VoyageStatus status) {
